...
var Index = {
    ...
    Directory: {
        ...
        navListTree: function (element) {
            ...
            var listUrl = '/slong/index_header/list';
            // var treeData =[];
            var treeData = [
            ...
            function beforeRemove(treeId, treeNode) {
                if(("children" in treeNode)) {
                    Common.warningAlert("该导航下有子导航，不能删除");
                    return false;
                }
                swal({
                        title: "警告",
                        text: "<h4>确定要删除该导航吗？</h4>",
                        html: true,
                        type: "warning",
                    ...
                    function() {
                        $.ajax({
                            async: false,
                            url: '/slong/index_header/ajaxDeleteHeader',
                            type: 'get',
                            dataType: 'json',
